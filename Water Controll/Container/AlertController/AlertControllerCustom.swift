...
//    }
   ...
   //     setSizeButtonTitle()
    ...
    private func createButton(in view: UIView, with text: String, isPicture: Bool = false, activityIndicator: inout UIActivityIndicatorView?) {
        ...
        button.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: UIScreen.main.bounds.width >= UIScreen.main.bounds.height ? 1/5 : 1/3, constant: -10).isActive = true
